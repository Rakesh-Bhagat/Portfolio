...
const Footer = () => {
  return (
    <div className="md:max-w-2xl mt-10 flex flex-col sm:flex-row gap-5 items-center sm:items-start justify-between px-2 py-5 border-t border-neutral-300 dark:border-neutral-600 dark:text-neutral-500">
